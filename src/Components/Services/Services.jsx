...
import service_5 from '../../assets/english-for-it.png';
...
const Services = () => {
    ...
    //     'English for IT': 'Content for English for IT...'
    // };
    // useEffect(() => {
    ...
    return (
        <div className='services'>
            ...
            <div className="service" onClick={() => openModal('General English')}>
                <p className='general-eng'>
                <span className="full-text">General English</span>
                <span className="short-text">General</span>
                </p>
                <img src={service_1} alt="" />
            </div>
            <div className="service" onClick={() => openModal('Business English')}>
                <p className='business-eng'>
                <span className="full-text">Business English</span>
                <span className="short-text">Business</span>
                </p>
                <img src={service_2} alt="" />
            </div>
            <div className="service" onClick={() => openModal('IELTS preparation')}>
                <p className='ielts'>
                <span className="full-text">IELTS preparation</span>
                <span className="short-text">IELTS</span>
                </p>
            ...
            <div className="service" onClick={() => openModal('English for IT')}>
                <p>English for IT </p>
